...
def main():
    ...
    detection_file = '/home/zhubinglab/Desktop/mmdetection3d/data/nuscenes/official_inference_result/centerpoint_val_detection.json'
    ...
    #all_results = EvalBoxes.deserialize(data, DetectionBox)
    meta = data['meta']
    print('meta: ', meta)
    ...
    submission['results']=tracking_results
    with open('/home/zhubinglab/Desktop/trainval_submission.json', 'w') as outfile:
